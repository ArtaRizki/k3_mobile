...
/*
{
  "id": "01jy0v4fa1jwzxhnv4wvhye8bs",
  "file": "http://10.0.2.2:8000/file_detail_inspeksi/1750227631_68525aaf67224.jpeg",
  "file_name": "1750227631_68525aaf67224.jpeg"
} 
*/
  ...
  InspectionViewModelDataBuktiFoto({
    this.id,
    this.file,
    this.fileName,
  });
...
/*
{
  "id": "01jy0v4f9fdfqr5htwmrp07nym",
  "created_at": "18/06/2025",
  "code": "002/F.INS-UA/K3L-MKP/I/1970",
  "type": "0",
  "kategori_name": "null",
...
*/
  ...
  InspectionViewModel.fromJson(Map<String, dynamic> json) {
    data = (json['data'] != null) ? InspectionViewModelData.fromJson(json['data']) : null;
